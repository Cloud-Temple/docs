---
title: Accordo di Servizio SecNumCloud OpenIaaS
---

# 1. ACCORDO DI SERVIZI OpenIaaS

  -----------------------------------------------------------------------
  **Destinatari:**            **COMMITTENTE**
  ------------------------------ ----------------------------------------
  **Riferimento del documento**     CT.AM.JUR.ANX OPENIaaS-
...
------------------------------------------------------------------------
  ...
  **Versione**   **Data**     **Azione**                           **Autore**
  ...
  v2.0          29/03/2024   Adeguamenti conformità SNC           Nicolas
                                                                  ABRIOUX
...
- [1. **ACCORDO DI SERVIZI IaaS**](#Xc3786c07943ae71dec5191b24567a7f31cb6100)
...
- [7. Descrizione del Servizio](#X3d12a6c93683f0122f5f9a8e21e7c12fc92490b)
  ...
  - [7.2. Presentazione dettagliata del perimetro del Servizio](#Xd81ad0562f6e00e693916802084624b2a4885a5)
    - [7.2.1. Infrastrutture Datacenter](#Xfd30a9e9ca5808eb0dd2b0f76d8755ff494726d)
    - [7.2.2. Infrastruttura software per la gestione del Servizio](#X429d709e167549b1f31f4cdbe79bbf526f0b1dc)
    ...
    - [7.2.6. Infrastruttura di backup](#Xdf2c99a6958ca2f79a1cf60659dd5a3029ab31c)
    - [7.2.7. Implementazione di soluzioni di ripristino o continuità operativa](#X5610bffa77dd118e87cbee05f204158179c962f)
  - [7.3. Limitazioni dei servizi nel modello OpenIaaS in corso di qualificazione](#X9afa960ae3673041349d17f6a264de8fb35d3b0)
    - [7.3.1. Servizi gestiti in modalità RUN](#Xa64cd9832e1132b6d2d4e8ef50163a925fcceeb)
    - [7.3.2. Configurazione del disaster recovery](#Xfc39a8474ae9c8d4eedbb3b8e543dc0a137bd71)
    - [7.3.3. Configurazione del backup](#Xfd8664b285a442773de0c9989256f92bc1f6ca2)
...
- [8. Impegni e livelli di servizio](#Xf1662fa601c14a35f4b238c1effe9c712d3efbe)
  ...
  - [8.4. Impegno di disponibilità dello storage di oggetti S3](#Xd1858bb2ec86b964cb6a768cb7d9a7a780abb7b)
  - [8.5. Precisazione riguardante l'impegno di backup](#Xcc0ee164bf81418fd2280ceac4eb569bf7b97f7)
- [9. Organizzazione della relazione contrattuale](#Xf5428518d06ee6569b2c74ea4a26421ab0998e2)
  ...
  - [9.4. Responsabilità di terzi che partecipano alla fornitura del servizio](#Xc662a81cadd2baa300ca83a27240dec61621a56)
...
- [10. Ciclo di vita del presente Accordo di servizio](#X89744c1f67247955b75e73d73aaa55899645415)
  ...
  - [10.2. Evoluzioni dell'Accordo di servizio](#Xb5b2d189dece37be8660fbd35b3e0d097bb2969)
    - [10.2.1. Evoluzioni avviate dal COMMITTENTE](#X946a5e541a54ab2f0ca92ca2e5ab41b3740f564)
...
Il presente documento formalizza l'Accordo di servizio associato al servizio OpenIaaS in corso di qualificazione SecNumCloud.

Il Servizio è in corso di qualificazione SecNumCloud (vedere certificazione che sarà in Allegato).

Il presente accordo di servizio completa ed è complementare alle condizioni generali di vendita e utilizzo del Fornitore. Si intende che i documenti contrattuali si interpretano in modo coerente tra loro. In caso di contraddizione o divergenza tra i termini dei documenti contrattuali, i documenti prevarranno gli uni sugli altri nel seguente ordine:
...
Le espressioni di seguito utilizzate nel presente Accordo di servizio saranno interpretate conformemente alle definizioni loro attribuite di seguito:
...
- **Cambiamento standard:** Cambiamento oggetto di una procedura, le cui modalità di messa in produzione e impatti (compresi quelli finanziari) sono conosciuti e accettati in anticipo dalle Parti. Viene quindi integrato nel catalogo dei cambiamenti standard, e può a seconda dei casi avere un GTI e un GTR.

- **Contratto:** designa il contratto sottoscritto dal COMMITTENTE presso il Fornitore per permettere al COMMITTENTE di beneficiare del Servizio, e a cui è allegato il presente Accordo di servizio.

- **Accordo di servizio:** Questo documento, stabilito nel quadro di un contratto specifico o delle Condizioni Generali di Vendita e Utilizzo (CGVU), e questo, in conformità con le esigenze del Referenziale SecNumCloud.

- **Richiesta di servizio:** richiesta di evoluzione oggetto di una procedura, la cui realizzazione: i) non modifica la CMDB, ii) la modalità operativa, i costi e i rischi sono conosciuti e accettati in anticipo e non richiedono modalità di ritorno indietro specifiche iii) la realizzazione è soggetta a un accordo di livello di servizio ed è inclusa nel canone del contratto quando viene realizzata in orario lavorativo e giorni lavorativi.
...
- **Dati tecnici**: comprende l'insieme dei dati manipolati per fornire il Servizio, in particolare includendo l'identità dei beneficiari e degli amministratori dell'infrastruttura tecnica, registri dell'infrastruttura tecnica, configurazione degli accessi, directory, certificati...
...
- **Incidente di sicurezza:** Qualsiasi evento nel perimetro del Servizio:
  ...
  - Di natura accidentale che pregiudica l'integrità, la riservatezza o la tracciabilità del Servizio o dei dati del COMMITTENTE;
  - Che pregiudica le misure di sicurezza esistenti. Gli attentati alla Disponibilità di origine non malevola non sono considerati come un Incidente di sicurezza (guasto hardware, bug, malfunzionamento, sinistro naturale...).
...
- **Problema**: causa di uno o più Incidenti ricorrenti, causa di un Incidente potenziale (situazione a rischio) che necessita di un'analisi e una risoluzione per prevenirne la ricorrenza.

- **Regione:** designa un insieme geograficamente delimitato di zone di disponibilità cloud, che fornisce servizi di rete, di calcolo e di archiviazione per ottimizzare la latenza, le prestazioni e la conformità normativa locale.

- **Servizio OpenIaaS:** designa il servizio IaaS basato su una tecnologia opensource, in corso di qualificazione SecNumCloud, fornito al COMMITTENTE dal Fornitore da infrastrutture tecniche mantenute dal Fornitore, come descritto nella sezione "Descrizione del Servizio" del presente Accordo di servizio.
...
# 4. Acronimi
  ...
  **CMDB**       Configuration Management Database -- Database di gestione
  ...
  **RPO**        Recovery Point Objective -- Freschezza dei dati ripristinati
                 in caso di Sinistro
  ...
  **TMA**        Manutenzione Applicativa da Terzi
...
È opportuno notare che una modifica o un adeguamento della qualificazione SecNumCloud non sarà interpretato come una revoca della qualificazione iniziale.
...
1. L'Agenzia Nazionale della Sicurezza dei Sistemi Informativi (ANSSI) così come all'entità di qualificazione competente per intraprendere la verifica della conformità del Servizio e del suo sistema informativo al referenziale SecNumCloud.
2. Un fornitore di audit della sicurezza dei sistemi informativi, debitamente qualificato PASSI ed espressamente designato dal Fornitore, per condurre audit di sicurezza relativi al Servizio.
...
Il modello di responsabilità condivisa applicato tra il Fornitore e il COMMITTENTE nel quadro del Servizio è presentato in §7.1.
...
## 7.2. Presentazione dettagliata del perimetro del Servizio
  ...
  Storage di       messa a disposizione di un'infrastruttura di storage di
  oggetti S3       oggetti sovrano multi AZ e compatibile con le API S3 standard.

  Backup           Modulo sottoscrizione allo Storage di oggetti S3

  Infrastruttura   Risorsa di rete del Tenant COMMITTENTE
  di rete

  Console          Il servizio che permette al COMMITTENTE di accedere al suo
  COMMITTENTE      servizio OpenIaaS e di amministrarlo tramite l'interfaccia Shiva

Supporto          Il servizio di supporto che accompagna i servizi precedenti
                   e unicamente questi (*)
  ------------------------------------------------------------------------

\_(*) Nel limite del perimetro del Servizio in corso di qualificazione
SNC e delle responsabilità del Fornitore in materia\_

### 7.2.1. Infrastrutture Datacenter

Il Servizio comprende la messa a disposizione, per ogni Zona di disponibilità, delle prestazioni qualificate qui di seguito:
...
- Alimentazione elettrica sicura, garantita da due circuiti elettrici distinti, che garantiscono una continuità di servizio;
...
- Supervisione continua e metrologia dettagliata, che permettono un monitoraggio preciso e una gestione proattiva delle prestazioni e della sicurezza del servizio fornito.

Il Fornitore assicura la messa a disposizione di servizi avanzati di rilevamento e estinzione incendi, progettati per identificare e neutralizzare efficacemente qualsiasi principio di incendio all'interno delle installazioni. Questi sistemi sono essenziali per garantire la sicurezza delle apparecchiature e dei dati. Comprendono rilevatori di fumo ad alta precisione e dispositivi di estinzione che possono agire rapidamente senza danneggiare l'apparecchiatura informatica. Questo servizio è cruciale per prevenire i rischi di incendio, minimizzare i danni potenziali e garantire la continuità delle operazioni.

Il COMMITTENTE è informato che tutte le procedure e misure di sicurezza messe in atto, comprese le prove annuali di commutazione sui gruppi elettrogeni, sono essenziali per garantire la continuità e l'integrità dei servizi forniti. Queste pratiche sono progettate per minimizzare i rischi di guasto e garantire una reattività ottimale in caso di Incidente. Accettando queste condizioni, il COMMITTENTE riconosce l'importanza di queste misure e si impegna a cooperare pienamente per facilitarne l'attuazione. Il COMMITTENTE è anche incoraggiato
