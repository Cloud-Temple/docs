...
Si raccomanda di limitare il numero di chiamate API effettuate dalla propria automazione per rimanere al di sotto del limite di frequenza impostato per l'endpoint.
