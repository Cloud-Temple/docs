...
I conti per l'accesso alla console Shiva vengono creati dal conto principale del committente su invito (indipendentemente dal repository di autenticazione utilizzato).  
...
La creazione di un account utente nella tua organizzazione avviene tramite invito. Per invitare un utente a un'[Organizzazione](#organizzazioni), vai nel menu __'Amministrazione'__ a sinistra sul nastro verde dello schermo, quindi nel sottomenu __'Utenti'__.
...
Per impostazione predefinita, un utente non ha alcun diritto. È quindi necessario che l'amministratore che ha inviato l'invito gli assegni i diritti necessari per la sua attività. Basta fare clic sul menu __'Azioni'__ dell'utente e selezionare l'opzione __'Modifica'__.
...
La disconnessione di un utente deve essere effettuata nel suo __'Profilo'__, in alto a destra dello schermo, quindi selezionando __'Disconnetti'__.
...
La gestione degli abbonamenti consente di ricevere e-mail relative alle tematiche attivate, che vengono inviate automaticamente in caso di verificarsi di eventi corrispondenti.
...
| documentation_read                               | Consultazione delle risorse di documentazione Confluence                                                                    |
...
- __Federazione dei tenant__ (Produzione, Preproduzione, Sviluppo, Applicazione 1, Applicazione 2, ...) che definisci per i tuoi requisiti architetturali Cloud.
...
È tuttavia possibile organizzare le cose anche in base a una __visione applicativa__ o alla __criticità__:
