...
<div class="card-grid">
  <div class="card">
    ...
    <a href="/docs/public_cloud/vm_instances" class="card-link">Scopri VM Instances →</a>
  </div>
  <div class="card">
    ...
    <a href="/docs/iaas_opensource" class="card-link">Scopri IaaS OpenSource →</a>
  </div>
  <div class="card">
    <h3>IaaS VMware</h3>
    ...
    <a href="/docs/iaas_vmware" class="card-link">Scopri IaaS VMware →</a>
  </div>
</div>
