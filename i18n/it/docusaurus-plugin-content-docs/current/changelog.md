...
### 19 January 2026: Managed Kubernetes and VPC Enhancements
...
- **Managed Kubernetes**: KubeCost replaced with a more recent guide on **OpenCost**.
...
- **LLMaaS**: Aggiunta di una guida per configurare l'estensione VSCode CLINE e utilizzare direttamente dai modelli linguistici di Cloud Temple dall'editor.
