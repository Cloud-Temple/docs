...
<div class="hero-banner">
  <div class="hero-content">
    <h1 class="hero-title">Documentazione Cloud Temple</h1>
    <p class="hero-subtitle">Tutto ciò di cui hai bisogno per sfruttare i servizi cloud sovrani di Cloud Temple.</p>
    <div class="cert-row">
...
<div class="quickstart-grid">
  <a href="console/console" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Esplora la Console</div>
      <div class="quickstart-desc">Gestisci le tue risorse, ordini e accessi dall'interfaccia centrale di Cloud Temple.</div>
    </div>
  </a>
  <a href="storage/oss/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Object Storage S3</div>
      <div class="quickstart-desc">Configura il tuo primo bucket compatibile S3 in pochi minuti.</div>
    </div>
  </a>
  <a href="iaas_vmware/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Provisiona le VM</div>
      <div class="quickstart-desc">Crea le tue prime macchine virtuali sull'infrastruttura IaaS di Cloud Temple.</div>
    </div>
  </a>
  <a href="llmaas/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">LLMaaS — IA Sovrana</div>
      <div class="quickstart-desc">Accedi ai grandi modelli linguistici in un ambiente SecNumCloud.</div>
    </div>
  </a>
</div>
...
<div class="popular-links-grid">
  <a class="popular-link" href="console/console_quickstart">
    ...
    <div class="popular-link-desc">Guida rapida alla Console Cloud Temple</div>
  </a>
  <a class="popular-link" href="managed_kubernetes/quickstart">
    <div class="popular-link-title">Kubernetes Gestito <span>→</span></div>
    <div class="popular-link-desc">Distribuisci il tuo primo cluster Kubernetes</div>
  </a>
  <a class="popular-link" href="llmaas/api">
    <div class="popular-link-title">Documentazione API LLMaaS <span>→</span></div>
    <div class="popular-link-desc">Riferimento completo dell'API compatibile OpenAI</div>
  </a>
  <a class="popular-link" href="bastion/quickstart">
    <div class="popular-link-title">Bastion — Accesso sicuro <span>→</span></div>
    <div class="popular-link-desc">Connessione SSH sicura alle tue risorse</div>
  </a>
  <a class="popular-link" href="iaas_vmware/concepts">
    <div class="popular-link-title">Architettura IaaS VMware <span>→</span></div>
    <div class="popular-link-desc">Comprendere l'infrastruttura virtualizzata di Cloud Temple</div>
  </a>
  <a class="popular-link" href="console/iam/iam">
    <div class="popular-link-title">IAM & Gestione degli accessi <span>→</span></div>
    <div class="popular-link-desc">Identità, ruoli e permessi nel tuo tenant</div>
  </a>
</div>
