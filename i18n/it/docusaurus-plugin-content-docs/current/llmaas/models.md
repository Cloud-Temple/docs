...
Cloud Temple LLMaaS offre **45 modelli di linguaggio grandi** selezionati e ottimizzati con cura per soddisfare le esigenze **SecNumCloud** più rigorose. Il nostro catalogo copre l'intero spettro, dai micro-modelli estremamente efficienti ai modelli estremamente grandi.
...
Modello multilingue di punta sviluppato da Meta, progettato per eccellere nel dialogo naturale, nel ragionamento complesso e nella comprensione dettagliata delle istruzioni.  

**Specifiche tecniche:**  
- **Velocità** : 26 token al secondo  
...
**Etichette:** `Agente` `Dialogo` `Multilingue`  
...
- Scenari che richiedono un equilibrio tra costo e prestazioni (MoE) su VLLM
- Dialoghi a più giri coinvolgenti con segnalazione precisa delle istruzioni
...
**Specifiche tecniche:**  
- **Velocità:** 21 token al secondo  
- **Consumo:** 12,56 kWh/million token  
- **Licenza:** Licenza MIT  
- **Localizzazione:** FR 🇫🇷  
...
**Tags :** `Visione` `Agente` `Ragionamento` `OCR` `Localizzazione Visiva` `Grande`  

**Casi d'uso:**  
- Analisi di documenti e diagrammi molto complessi  
- Agenti visivi autonomi per la navigazione e l'interazione con le GUI  
- Compiti di localizzazione di oggetti e riconoscimento del testo ad alta precisione  
...
Versione più potente della serie Qwen2.5-VL, che offre capacità di comprensione visiva e agenti di punta per le attività più esigenti.
...
- Analisi di documenti e diagrammi molto complessi
- Agenti visivi autonomi per la navigazione e l'interazione con le GUI
- Attività di localizzazione di oggetti e riconoscimento del testo di alta precisione
...
Modello di rete neurale Qwen3 (14B) di nuova generazione, che offre prestazioni equivalenti a Qwen2.5 32B con una maggiore efficienza.  
...
**Casi d'uso:**  
- Compiti generali che richiedono prestazioni elevate e un ampio contesto  
- Generazione di contenuti creativi e tecnici  
- Analisi dei dati e ragionamento complesso  
- Integrazione con strumenti esterni tramite chiamate di funzione
...
**Tags:** `Visione` `Veloci` `Grande Contesto`  
...
- Depliamenti su larga scala con capacità visive e testuali  
...
Micro-modello estremamente leggero progettato per i deploy su dispositivi con risorse estremamente limitate.  
...
**Casi d'uso:**  
- Deploy su dispositivi IoT e sistemi embedded con integrazione API  
...
Modello multilingue open-source a causa (7B), finetunato da Lucie-7B. Ottimizzato per il francese.  
...
Aggiornamento minore di Mistral Small 3.1, che migliora il follow-up delle istruzioni, la robustezza del function calling e riduce gli errori di ripetizione.
...
Aggiornamento minore di Mistral Small 3.1, che migliora il follow-up delle istruzioni, la robustezza della chiamata di funzione e riduce gli errori di ripetizione.  

**Specifiche tecniche:**  
- **Velocità** : 50 token/secondo  
- **Consumo** : 5,28 kWh/milione di token  
- **Licenza** : Apache 2.0  
- **Localizzazione** : FR 🇫🇷  
...
**Casi d'uso:**  
- Agenti conversazionali con un follow-up delle istruzioni migliorato  
- Integrazione robusta con strumenti esterni tramite chiamata di funzione  
- Applicazioni che richiedono una grande affidabilità per evitare ripetizioni  
- Casi d'uso identici a Mistral Small 3.1 con prestazioni migliorate  
...
Modello compatto rivoluzionario di IBM specializzato nella visione computerizzata, in grado di analizzare e comprendere direttamente i documenti visivi senza ricorrere a tecnologie OCR intermedie.  

**Specifiche tecniche:**  
- **Velocità:** 48 token al secondo  
- **Consumo:** 0,69 kWh per milione di token 🌱  
- **Licenza:** Apache 2.0  
- **Localizzazione:** FR 🇫🇷  
...
- Visione computerizzata leggera (2B parametri) con velocità elevata (50 token/s)

### Granite 3.3 8B  
**IBM • 8B parametri • Contesto: 60 000 token**  

Modello Granite 8B ottimizzato da IBM per un ragionamento e un seguito delle istruzioni migliorati, con un contesto di 128k token.  
...
**Casi d'uso:**  
- Compiti di seguito alle istruzioni (classificazione, estrazione, Q&A)  
...
- Ragionamento strutturato con la modalità "Pensiero"
...
**Casi d'uso:**  
- Distribuzioni leggere con ampio contesto (128k token)  
...
- Generazione/completo di codice FIM su workstation standard

### Mistral 24B  
**Mistral AI • 24B parametri • Contesto : 40 000 token**  

Il primo modello di ragionamento di Mistral AI, eccellente nel ragionamento specifico del settore, trasparente e multilingue.  

**Specifiche tecniche :**  
- **Velocità** : 25 token/secondo token/secondo  
...
**Casi d'uso:**  
- Applicazioni generaliste con costo di inferenza ottimizzato (42 token al secondo)  
...
Versione avanzata del modello Cogito che offre capacità di ragionamento e analisi notevolmente ampliate, progettata per le applicazioni più esigenti in ambito di intelligenza artificiale analitica.  
...
Modello da 32 miliardi di parametri migliorato con apprendimento per rinforzo (RL) per eccellere nel ragionamento, nella codifica, nelle matematiche e nelle attività degli agenti.
...
Versione compatta ed efficiente del modello DeepSeek-R1, che offre un ottimo compromesso tra prestazioni e leggerezza per le implementazioni che richiedono flessibilità e reattività.  
...
**Tags :** `Ragionamento` `Compatto` `In embedded` `Efficiente` `Veloce`
...
Modello compatto di IBM specializzato nella sicurezza e nel rispetto delle normative, che rileva i rischi e i contenuti inappropriati.  
...
**Tag :** `Sicurezza` `Rispetto delle normative` `Compatto` `Filtraggio` `Efficiente`

### Granite 3 Guardian 8B  
**IBM • 8B parametri • Contesto: 32.000 token**  

Modello IBM specializzato nella sicurezza e nella conformità, offrendo capacità avanzate di rilevamento dei rischi.  
...
**Specifiche tecniche:**  
- **Velocità** : 162 token al secondo ⚡  
- **Consumo** : 0.1 kWh per milione di token 🌱  
- **Licenza** : MIT  
- **Localizzazione** : FR 🇫🇷  
...
**Tags:** `Ultra-compacto` `Veloci` `Incorporato` `Efficiente`
...
**Tags:** `Compacto` `Veloce` `Integrato` `Efficiente`
...
**Etichette:** `Polivalente` `Multilingue` `Veloci`

### Qwen 2.5 32B
**Qwen Team • 32B parametri • Contesto: 32 000 token**

Modello potente della famiglia Qwen 2.5, che offre capacità avanzate di comprensione e generazione.
...
**Specifiche tecniche:**
- **Velocità** : 64 token/secondo ⚡
- **Consumo** : 0.52 kWh/million token 🌱
- **Licenza** : MIT license
- **Localizzazione** : FR 🇫🇷
...
**Tags :** `Compatto` `Veloci` `Polivalente` `Efficiente`

### Qwen3 0.6b  
**Team Qwen • 0,6B parametri • Contesto: 32 000 token**  
...
Modello molto compatto della famiglia Qwen3, che offre un buon equilibrio tra prestazioni e dimensioni per implementazioni leggere.  
...
**Tags :** `Compatto` `Veloce` `Embarcato` `Efficiente`
...
Modello Visione-Linguaggio compatto, soluzione performante per l'AI in edge (edge AI).  

**Specifiche tecniche:**  
- **Velocità:** 65 token/secondo ⚡  
- **Consumo:** 0.51 kWh/million token 🌱  
- **Licenza:** Apache 2.0  
- **Localizzazione:** FR 🇫🇷  
...
Modello Vision-Langage performante, superiore a GPT-4o-mini in alcune attività.
...
**Specifiche tecniche :**
- **Velocità** : 21 tokens/seconde tokens/seconde
- **Consumo** : 1.59 kWh/million tokens
- **Licenza** : Apache 2.0
- **Localizzazione** : FR 🇫🇷
...
**Tag:** `Agent` `Programmazione` `Open-Source` `Grande Contesto`  
...
### Cogito 8B  
**Deep Cogito • 8B parametri • Contesto: 32 000 tokens**  
...
**Specifiche tecniche:**  
- **Velocità:** 30 tokens/secondo  
- **Consumo:** 1,11 kWh/milione di tokens 🌱  
- **Licenza:** Licenza Community LLAMA 3.2  
- **Localizzazione:** FR 🇫🇷  
...
- **Licenza** : Licenza LLAMA 3.1 Community  
- **Localizzazione** : FR 🇫🇷  
...
**Tag:** `Ragionamento` `Matematica` `Programmazione` `Velocità`

## Casi d'uso consigliati

### Dialogo multilingue  
Chatbot e assistenti in grado di comunicare in più lingue con rilevamento automatico, mantenimento del contesto durante tutta la conversazione e comprensione delle specificità linguistiche  
...
Trattamento di documenti voluminosi (>100 pagine) con mantenimento del contesto su tutto il testo, estrazione di informazioni chiave, generazione di riassunti rilevanti e risposta a domande specifiche sul contenuto
...
Generazione e ottimizzazione del codice in più linguaggi, debugging, refactoring, sviluppo di funzionalità complete, comprensione di implementazioni algoritmiche complesse e creazione di test unitari
...
### Deployment leggeri ed embedded
