...
Cloud Temple LLMaaS propone **modelli di linguaggio su larga scala** selezionati e ottimizzati con cura. Il nostro catalogo copre l'intero spettro, dai micro-modelli estremamente efficienti ai modelli estremamente grandi.

### Nota sulle misure di prestazione
I valori di velocità (tokens/s) rappresentano obiettivi di prestazione in condizioni reali. Il consumo energetico (kWh/Mtoken) è calcolato dividendo la potenza stimata del server di inferenza (in Watt) per la velocità misurata del modello (in tokens/secondo), quindi convertito in chilowattora per milione di token. Questo metodo offre un confronto pratico sull'efficienza energetica dei diversi modelli, da utilizzare come indicatore relativo piuttosto che come misura assoluta del consumo elettrico.
...
| **Contesto minimo** | 8 192 tokens |
| **Contesto massimo** | 120 000 tokens |
...
- **Licenza** : [LLAMA 3.3 Community Licence](./licences/llama3.3_70b.licence.md)
- **Localizzazione** : FR 🇫🇷
...
### Qwen3 235B  
**Team Qwen • 235B parametri • Contesto: 32.000 token**  
...
- **Consumo** : 6,35 kWh per milione di token  
...
- **Licenza** : [Termini di utilizzo di Google Gemma](./licences/gemma3_27b.licence.md)  
- **Localizzazione** : FR 🇫🇷  
...
- Indicizzazione e ricerca semantica in grandi basi di dati documentali  
...
### Qwen3 30B-A3B FP8
**Team Qwen • 30B-A3B parametri • Contesto: 32.000 token**
...
- Dialoghi multi-turn coinvolgenti e seguito preciso delle istruzioni
...
- **Licenza** : [MIT License](./licences/deepseek-r1_70b.licence.md)  
- **Localizzazione** : FR 🇫🇷  
...
Modello di rete neurale denso di nuova generazione Qwen3 (14B), che offre prestazioni equivalenti a Qwen2.5 32B con un'efficienza migliore.  
...
**Casi d'uso:**  
- Applicazioni multimediali con vincoli di risorse moderati  
...
- **Licenza** : [Termini di utilizzo di Google Gemma](./licences/gemma3_4b.licence.md)  
- **Localizzazione** : FR 🇫🇷  
...
Micro-modello ultra-leggero progettato per deployment su dispositivi con risorse estremamente limitate.  

**Specifiche tecniche:**  
- **Velocità** : 41 token al secondo  
...
Modello causale multilingue open-source (7B), fine-tuned da Lucie-7B. Ottimizzato per il francese.  
...
- Implementazione di algoritmi complessi (grafi, alberi, euristici)  
- Trasposizione del codice tra linguaggi e framework (ad esempio Python verso JavaScript)  
- Creazione automatica di test unitari con copertura del codice > 80%

### Granite 3.2 Vision  
**IBM • 2B parametri • Contesto: 16 384 token**  

Modello compatto rivoluzionario di IBM specializzato nella visione artificiale, in grado di analizzare e comprendere direttamente i documenti visivi senza utilizzare tecnologie OCR intermedie.  
...
Modello Granite 8B ottimizzato da IBM per un ragionamento e un follow-up delle istruzioni migliorati, con un contesto di 128k token.  
...
**Casi d'uso:**  
- Compiti generali di follow-up delle istruzioni (classificazione, estrazione, Q&A)  
...
**Casi d'uso:**  
- Deploy leggeri con grande contesto (128k token)  
...
- Depliamenti ad alta densità con basso consumo energetico per inferenza  
...
Modello Deep Cogito progettato specificamente per eccellere nei compiti di ragionamento profondo e di comprensione contestuale sottile, ideale per applicazioni analitiche avanzate.  
...
- Sistemi di risposta precisa su corpus documentari specializzati  
...
- Sistemi esperti in settori specializzati (giuridico, medico, tecnico)  
...
Modello potente della nuova generazione Qwen3, che offre capacità avanzate in ragionamento, codifica e agentica, con un contesto esteso.  
...
- Risoluzione di problemi complessi (matematica, codifica) con il modo "Thinking"  
...
Modello da 32 miliardi di parametri migliorato con apprendimento per rinforzo (RL) per eccellere nel ragionamento, nella codifica, nella matematica e nelle attività degli agenti.  
...
- **Velocità:** 60 token/secondo ⚡  
- **Consumo:** 3,05 kWh/milione di token  
- **Licenza:** [MIT license](./licences/deepseek-r1_14b.licence.md)  
- **Localizzazione:** FR 🇫🇷  
...
- **Licenza:** [licenza MIT](./licences/deepseek-r1_32b.licence.md)  
- **Localizzazione:** IT 🇮🇹  
...
- **Licenza** : [Licenza Comunitaria LLAMA 3.2](./licences/cogito_3b.licence.md)
- **Localizzazione** : FR 🇫🇷
...
Modello compatto di IBM specializzato nella sicurezza e nel conformità, che rileva i rischi e i contenuti inappropriati.  
...
Modello IBM specializzato nella sicurezza e conformità, con capacità avanzate di rilevamento dei rischi.  
...
### Qwen 2.5 0.5B  
**Team Qwen • 0.5B parametri • Contesto: 32.000 token**  

Micro-modello ultra-leggero della famiglia Qwen 2.5, progettato per un'efficienza massima su dispositivi vincolati.  

**Specifiche tecniche:**  
- **Velocità** : 57 token/secondo ⚡  
- **Consumo** : 0.95 kWh/milione di token 🌱  
- **Licenza** : [Licenza MIT](./licences/qwen2.5_0.5b.licence.md)  
- **Localizzazione** : FR 🇫🇷  
...
- **Consumo** : 5,73 kWh/milione di token  
- **Licenza** : [licenza MIT](./licences/qwen2.5_32b.licence.md)  
- **Localizzazione** : FR 🇫🇷  
...
- **Licenza** : [MIT license](./licences/qwen2.5_3b.licence.md)
- **Localizzazione** : FR 🇫🇷
...
Modello Vision-Langage compatto, soluzione performante per l'AI periferica (edge AI).
...
Chatbot e assistenti in grado di comunicare in più lingue con rilevamento automatico, mantenimento del contesto sull'intera conversazione e comprensione delle specificità linguistiche
...
Applicazioni che richiedono capacità specifiche in materia di sicurezza; filtraggio del contenuto sensibile, tracciabilità dei ragionamenti, verifica del RGPD/HDS, minimizzazione dei rischi, analisi delle vulnerabilità e rispetto delle regolamentazioni settoriali
