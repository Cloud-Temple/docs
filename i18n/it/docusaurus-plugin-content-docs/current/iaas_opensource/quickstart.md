...
L'interfaccia di gestione delle macchine virtuali è disponibile nella console Shiva nel menu __'OpenIaaS'__ situato sulla barra verde a sinistra dello schermo.
