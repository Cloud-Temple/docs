...
<div className="card-grid">
  <div className="card">
    ...
    <a href="iaas_bare-metal/concepts" className="card-link">Esplora i concetti &rarr;</a>
  </div>
  <div className="card">
    <h3>Quickstart</h3>
    <p>Iniziate rapidamente con le nostre risorse seguendo istruzioni chiare e semplici.</p>
    <a href="iaas_bare-metal/quickstart" className="card-link">Inizia il Quickstart &rarr;</a>
  </div>
    <div className="card">
    <h3>Tutorials</h3>
    <p>Imparate passo dopo passo a configurare e utilizzare i nostri servizi con guide dettagliate.</p>
    <a href="iaas_bare-metal/tutorials" className="card-link">Scopri i tutorial &rarr;</a>
  </div>
</div>
