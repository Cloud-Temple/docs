...
<div class="card-grid">
  <div class="card">
    <h3>VPC</h3>
    <p>Virtual Private Cloud: Segmentieren und isolieren Sie Ihre Ressourcen in dedizierten virtuellen Netzwerken mit benutzerdefiniertem Routing.</p>
    <a href="./vpc" class="card-link">VPC entdecken →</a>
  </div>
  <div class="card">
