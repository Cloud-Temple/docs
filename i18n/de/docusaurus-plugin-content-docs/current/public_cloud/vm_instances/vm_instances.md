...
![VM Instances-Liste in der Cloud Temple Console](./images/vm_instances_liste.png)

<div class="card-grid">
  <div class="card">
    <h3>Konzepte</h3>
    <p>Entdecken Sie die Architektur, Service-Klassen und Funktionen des VM Instances-Dienstes.</p>
    <a href="/public_cloud/vm_instances/concepts" class="card-link">Konzepte erkunden &rarr;</a>
  </div>
  <div class="card">
    <h3>Quickstart</h3>
    <p>Stellen Sie Ihre erste virtuelle Maschine in wenigen Minuten aus dem Cloud Temple Marketplace bereit.</p>
    <a href="/public_cloud/vm_instances/quickstart" class="card-link">Quickstart starten &rarr;</a>
  </div>
  <div class="card">
    <h3>Tutorials</h3>
    <p>Praxisanleitungen: VM erstellen, Festplatten verwalten, Snapshots aufnehmen.</p>
    <a href="/public_cloud/vm_instances/tutorials" class="card-link">Tutorials ansehen &rarr;</a>
  </div>
</div>
