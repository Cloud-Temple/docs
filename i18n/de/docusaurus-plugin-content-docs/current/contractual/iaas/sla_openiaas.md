---
title: SecNumCloud OpenIaaS Servicevereinbarung
---

# 1. OpenIaaS SERVICEVEREINBARUNG

  -----------------------------------------------------------------------
  **Empfänger:**            **AUFTRAGGEBER**
  ------------------------------ ----------------------------------------
  **Dokumentreferenz**     CT.AM.JUR.ANX OPENIaaS-
...
Dieses Dokument formalisiert die Servicevereinbarung für den OpenIaaS-Service, der sich im Prozess der SecNumCloud-Qualifizierung befindet.

Der Service befindet sich im Prozess der SecNumCloud-Qualifizierung (siehe Bescheinigung, die im Anhang beigefügt wird).
...
- **OpenIaaS-Service:** bezeichnet den auf Open-Source-Technologie basierenden IaaS-Service, der sich im Prozess der SecNumCloud-Qualifizierung befindet und dem AUFTRAGGEBER vom Dienstleister von technischen Infrastrukturen aus bereitgestellt wird, die vom Dienstleister gewartet werden, wie im Abschnitt "Beschreibung des Services" dieser Servicevereinbarung beschrieben.
