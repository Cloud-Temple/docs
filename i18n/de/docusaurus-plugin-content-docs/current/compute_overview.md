...
<div class="card-grid">
  ...
  <div class="card">
    ...
    <p>Open-Source-virtualisierte Infrastruktur (OpenStack). Volle Kontrolle über Ihre VMs, Netzwerke und Speicher auf einer SecNumCloud-zertifizierten Basis.</p>
    <a href="./iaas_opensource" class="card-link">IaaS OpenSource entdecken →</a>
  </div>
  <div class="card">
    <h3>IaaS VMware</h3>
