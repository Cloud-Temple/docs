...
<div class="hero-banner">
  <div class="hero-content">
    ...
    <p class="hero-subtitle">Alles, was Sie benötigen, um die souveränen Cloud-Dienste von Cloud Temple zu nutzen.</p>
    <div class="cert-row">
...
<div class="quickstart-grid">
  <a href="console/console" class="quickstart-card">
    ...
    <div>
      ...
      <div class="quickstart-desc">Verwalten Sie Ressourcen, Bestellungen und Zugriffe über die zentrale Cloud Temple Oberfläche.</div>
    </div>
  </a>
  <a href="storage/oss/quickstart" class="quickstart-card">
    ...
    <div>
      ...
      <div class="quickstart-desc">Richten Sie in wenigen Minuten Ihren ersten S3-kompatiblen Bucket ein.</div>
    </div>
  </a>
  ...
  <a href="llmaas/quickstart" class="quickstart-card">
    ...
    <div>
      ...
      <div class="quickstart-desc">Greifen Sie in einer SecNumCloud-Umgebung auf große Sprachmodelle zu.</div>
    </div>
  </a>
</div>
...
<div class="popular-links-grid">
  <a class="popular-link" href="console/console_quickstart">
    <div class="popular-link-title">Konsole Quickstart <span>→</span></div>
    <div class="popular-link-desc">Schnellstart-Anleitung für die Cloud Temple Konsole</div>
  </a>
  ...
  <a class="popular-link" href="bastion/quickstart">
    <div class="popular-link-title">Bastion — Sicherer Zugang <span>→</span></div>
  ...
  <a class="popular-link" href="iaas_vmware/concepts">
    ...
    <div class="popular-link-desc">Die virtualisierte Infrastruktur von Cloud Temple verstehen</div>
  </a>
