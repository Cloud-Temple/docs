...
Wenn die [Anzahl der verfügbaren Hosts](../../concepts.md#hochverfügbarkeit) nicht ausreicht, um die Hochverfügbarkeit zu gewährleisten, wird ein Warnhinweis angezeigt:
