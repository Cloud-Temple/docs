...
In the detailed view of a virtual machine template, you can access critical information such as location, number of disks, and number of network adapters.
...
| Ease of Management      | Fully integrated configuration and monitoring within the Cloud Temple Console.                                                                |
