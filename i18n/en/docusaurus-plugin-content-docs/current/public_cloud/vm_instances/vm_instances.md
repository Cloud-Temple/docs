...
<div class="card-grid">
  <div class="card">
    ...
    <a href="/public_cloud/vm_instances/concepts" class="card-link">Explore concepts &rarr;</a>
  </div>
  <div class="card">
    <h3>Quickstart</h3>
    <p>Deploy your first virtual machine in minutes from the Cloud Temple Marketplace.</p>
    <a href="/public_cloud/vm_instances/quickstart" class="card-link">Start the Quickstart &rarr;</a>
  </div>
  <div class="card">
    <h3>Tutorials</h3>
    <p>Practical guides: create a VM, manage disks, take snapshots.</p>
    <a href="/public_cloud/vm_instances/tutorials" class="card-link">View tutorials &rarr;</a>
  </div>
</div>
