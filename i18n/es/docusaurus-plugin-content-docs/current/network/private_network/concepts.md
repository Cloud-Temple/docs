...
Localizada dentro de un __[Tenant](../../console/iam/concepts.md)__, pueden extenderse entre las zonas de disponibilidad
...
Es así posible compartir una red entre sus __[Inquilino](../../console/iam/concepts.md)__ dentro de una misma organización.
