...
Al utilizar, reproducir, modificar, distribuir, realizar o mostrar cualquier parte o elemento de Gemma, Derivados del modelo, incluido a través de cualquier Servicio alojado (cada uno definido a continuación) (colectivamente, los "Servicios Gemma"), o de otra manera aceptar los términos de este Acuerdo, usted acepta estar obligado por este Acuerdo.
...
(e) "Derivados del modelo" significa todos (i) las modificaciones de Gemma, (ii) obras basadas en Gemma, o (iii) cualquier otro modelo de aprendizaje automático que se cree mediante la transferencia de patrones de los pesos, parámetros, operaciones o Salida de Gemma a ese modelo para que este realice funciones similares a las de Gemma, incluidos métodos de distilación que usen representaciones de datos intermedios o métodos basados en la generación de Salidas sintéticas por parte de Gemma para entrenar ese modelo. Para mayor claridad, las Salidas no se consideran Derivados del modelo.
...
En la máxima medida permitida por la ley, Google se reserva el derecho de restringir (de forma remota u otra) el uso de alguno de los Servicios Gemma que Google considere razonablemente que violan este Acuerdo.
...
4.1 Actualizaciones
Google puede actualizar Gemma periódicamente y usted debe hacer esfuerzos razonables para usar la versión más reciente de Gemma.
...
4.3 DECLARACIÓN DE GARANTÍA
A menos que lo exija la ley aplicable, los Servicios Gemma y las Salidas se proporcionan "tal cual", sin garantías o condiciones de ningún tipo, ya sean expresas o implícitas, incluyendo cualquier garantía o condición de titularidad, no infracción, comerciabilidad o idoneidad para un propósito particular. Usted es el único responsable de determinar la adecuación del uso, reproducción, modificación, realización, visualización o distribución de cualquiera de los Servicios Gemma o Salidas y asume cualquier y todos los riesgos asociados con su uso o distribución de cualquiera de los Servicios Gemma o Salidas y con el ejercicio de sus derechos y permisos bajo este Acuerdo.

4.4 LIMITACIÓN DE RESPONSABILIDAD
En la máxima medida permitida por la ley aplicable, en ningún caso y bajo ninguna teoría legal, ya sea en torta (incluida la negligencia), responsabilidad por productos, contrato u otra, a menos que lo exija la ley aplicable, Google o sus filiales no serán responsables ante usted por daños, incluyendo cualquier daño directo, indirecto, especial, incidental, ejemplar, consecuente o punitivo, o pérdidas de beneficios de cualquier tipo derivados de este Acuerdo o relacionados con, cualquier Servicio Gemma o Salida, incluso si Google o sus filiales han sido advertidos de la posibilidad de dichos daños.
...
4.7 Severabilidad
Si alguna disposición de este Acuerdo se considera inválida, ilegal o inadmisible, las restantes disposiciones no se verán afectadas por ello y permanecerán válidas como si dicha disposición no se hubiera establecido aquí.
