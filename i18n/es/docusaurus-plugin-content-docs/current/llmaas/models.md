...
Cloud Temple LLMaaS ofrece **45 modelos de lenguaje grandes** cuidadosamente seleccionados y optimizados para satisfacer los requisitos más estrictos de SecNumCloud. Nuestro catálogo cubre todo el espectro, desde micromodelos ultraeficientes hasta modelos de tamaño extremadamente grande.
...
| **Conformidad** | SecNumCloud ✅ HDS ✅ Sobriedad ✅ C5 ❌ |
| **Localización** | 100% France 🇫🇷 |
...
Modelo de gran tamaño de la nueva generación Qwen3, ofreciendo capacidades ampliadas para las tareas más complejas.

**Especificaciones técnicas:**
- **Velocidad**: 17 tokens/seconde
...
- **Consumo** : 11.11 kWh/millón de tokens
...
**Especificaciones técnicas:**
- **Velocidad** : 20 tokens por segundo
...
- Integración con herramientas externas mediante la API de llamada de funciones
...
- **Consumo** : 2,88 kWh por millón de tokens
- **Licencia** : Apache 2.0
- **Localización** : FR 🇫🇷
...
Modelo 70B de DeepSeek AI

**Especificaciones técnicas:**
- **Velocidad** : 21 tokens/segundo
- **Consumo** : 12,56 kWh/millon de tokens
- **Licencia** : Licencia MIT
- **Ubicación** : FR 🇫🇷
...
La versión más potente de la serie Qwen2.5-VL, que ofrece capacidades de comprensión visual y agente de vanguardia.
...
**Etiquetas:** `Visión` `Agente` `Razonamiento` `OCR` `Ubicación Visual` `Grande`

**Casos de uso:**
- Análisis de documentos y diagramas muy complejos
- Agentes visuales autónomos para navegación e interacción con interfaces gráficas
...
La versión más potente de la serie Qwen2.5-VL, ofreciendo capacidades de comprensión visual y agente de vanguardia para las tareas más exigentes.

**Especificaciones técnicas:**
- **Velocidad**: 15 tokens/segundo
- **Consumo**: 8,89 kWh/millón tokens
- **Licencia**: Apache 2.0
- **Localización**: FR 🇫🇷
...
**Casos de uso:**
- Análisis de documentos y diagramas muy complejos
- Agentes visuales autónomos para la navegación e interacción con GUI
...
Modelo denso de nueva generación Qwen3 (14B), ofreciendo rendimientos equivalentes a Qwen2.5 32B con una mayor eficiencia.

**Especificaciones técnicas:**
- **Velocidad**: 68 tokens/segundo ⚡
- **Consumo**: 3,88 kWh/millon de tokens
- **Licencia**: Apache 2.0
- **Ubicación**: FR 🇫🇷
...
**Tags :** `Ultra-compacto` `Embebido` `Eficiente` `Rápido`  
...
Modelo multilingüe de código abierto (7B), fine-tuned desde Lucie-7B. Optimizado para el francés.

**Especificaciones técnicas:**
- **Velocidad** : 4 tokens por segundo
...
Actualización menor de Mistral Small 3.1, mejorando el seguimiento de instrucciones, la robustez de la llamada a funciones y reduciendo los errores de repetición.  
...
**Casos de uso:**  
- Agentes de conversación con un seguimiento de instrucciones mejorado  
...
- **Consumo** : 4,12 kWh/millon de tokens  
- **Licencia** : Apache 2.0  
- **Ubicación** : FR 🇫🇷  
...
- Visión por computadora ligera (2 mil millones de parámetros) con alta velocidad (50 tokens/s)
...
- **Consumo** : 1.11 kWh/millon de tokens 🌱
- **Licencia** : Apache 2.0
- **Localización** : FR 🇫🇷
...
**Etiquetas:** `Agent` `Razonamiento` `Seguridad` `Eficiente`
...
### Granite 3.3 2B  
**IBM • 2B parámetros • Contexto: 128 000 tokens**  
...
El primer modelo de razonamiento de Mistral AI, destacando en el razonamiento específico del dominio, transparente y multilingüe.  

**Especificaciones técnicas:**  
- **Velocidad** : 25 tokens por segundo  
- **Consumo** : 5,33 kWh por millón de tokens  
- **Licencia** : Apache 2.0  
- **Ubicación** : FR 🇫🇷  
...
- Industrias reguladas (jurídico, finanzas) con razonamiento trazable  
- Ingeniería de software (planificación de proyectos, arquitectura)  
- Creación de contenido y comunicación (redacción creativa, narrativa)
...
- Procesamiento de documentos en entornos de CPU con uso de RAM limitado
...
- Sistemas de preguntas-respuestas precisos sobre corpora documentales especializados
...
- **Consumo** : 8,25 kWh/millon de tokens
...
**Especificaciones técnicas:**
- **Velocidad** : 18 tokens/segundo
- **Consumo** : 7,41 kWh/millon de tokens
- **Licencia** : Apache 2.0
- **Ubicación** : FR 🇫🇷
...
- **Consumo**: 7.54 kWh por millón de tokens
- **Licencia**: Apache 2.0
- **Ubicación**: FR 🇫🇷
...
- Prototipado rápido de aplicaciones IA con tiempos de iteración cortos
...
Modelo de embedding ultraligero de IBM para búsqueda semántica y clasificación.  
...
Micromodelo ultra-ligero de la familia Qwen 2.5, diseñado para una eficiencia máxima en dispositivos limitados.
...
Modelo muy compacto de la familia Qwen 2.5, que ofrece un buen equilibrio rendimiento/tamaño para despliegues ligeros.
...
**Etiquetas:** `Compacto` `Rápido` `Embarcado` `Eficiente`
...
- **Consumo**: 8,51 kWh/millón de tokens
- **Licencia**: Licencia MIT
- **Localización**: FR 🇫🇷
...
**Etiquetas:** `Polivalente` `Multilingüe` `Razonamiento`
...
**Especificaciones técnicas:**
- **Velocidad** : 64 tokens/segundo tokens/segundo ⚡
...
**Especificaciones técnicas:**
- **Velocidad** : 112 tokens por segundo tokens por segundo ⚡
...
- **Consumo** : 0.38 kWh/millon tokens 🌱
- **Licencia** : Apache 2.0
- **Localización** : FR 🇫🇷
...
- **Consumo:** 1.01 kWh/millón de tokens 🌱
- **Licencia:** Apache 2.0
- **Localización:** FR 🇫🇷
...
Modelo Visión-Lenguaje compacto, solución eficiente para la IA en el borde (edge AI).

**Especificaciones técnicas:**
- **Velocidad:** 65 tokens por segundo ⚡
- **Consumo:** 0.51 kWh por millón de tokens 🌱
- **Licencia:** Apache 2.0
- **Localización:** FR 🇫🇷
...
Modelo de lenguaje especializado en ciberseguridad, optimizado para la eficiencia.

**Especificaciones técnicas:**
- **Velocidad** : 21 tokens/segundo tokens/segundo
- **Consumo** : 1,59 kWh/millon de tokens
- **Licencia** : Apache 2.0
- **Localización** : FR 🇫🇷
...
Modelo de tamaño intermedio de la familia Cogito, que ofrece un buen equilibrio entre las capacidades de razonamiento y la eficiencia.
...
**Especificaciones técnicas:**
- **Velocidad** : 71 tokens por segundo ⚡
- **Consumo** : 3,71 kWh por millón de tokens
- **Licencia** : Licencia MIT
- **Localización** : FR 🇫🇷
...
Procesamiento de documentos voluminosos (>100 páginas) con mantenimiento del contexto a lo largo de todo el texto, extracción de información clave, generación de resúmenes pertinentes y respuesta a preguntas específicas sobre el contenido
