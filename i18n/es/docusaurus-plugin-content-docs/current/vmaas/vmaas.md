...
El servicio **VMaaS** de Cloud Temple permite el despliegue rápido de máquinas virtuales en una infraestructura compartida y de alto rendimiento. Esta oferta combina la flexibilidad de la nube pública con las garantías de seguridad de una nube soberana.
...
<div class="card-grid">
  <div class="card">
    <h3>Conceptos</h3>
    <p>Descubra la arquitectura, las clases de servicio y las funcionalidades del servicio VMaaS.</p>
