...
Encuentre a continuación las preguntas frecuentes sobre los productos y servicios de Cloud Temple.
...
<div class="book-grid">
  <a class="book-card book-card--violet" href="/llmaas/faq">
    ...
    <div class="book-card-body">
      ...
      <div class="book-card-cta">Ver FAQ →</div>
    </div>
  </a>
</div>
...
<div class="book-grid">
  <a class="book-card book-card--orange" href="/storage/oss/faq">
    ...
    <div class="book-card-body">
      ...
      <div class="book-card-desc">Preguntas sobre la gestión de buckets, derechos de acceso, protocolos compatibles y límites del servicio.</div>
      <div class="book-card-cta">Ver FAQ →</div>
    </div>
  </a>
</div>
