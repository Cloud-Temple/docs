...
<div class="hero-banner">
  <div class="hero-content">
    <h1 class="hero-title">Documentación Cloud Temple</h1>
    <p class="hero-subtitle">Todo lo que necesita para aprovechar los servicios cloud soberanos de Cloud Temple.</p>
    <div class="cert-row">
...
<div class="quickstart-grid">
  <a href="console/console" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Explorar la Consola</div>
      <div class="quickstart-desc">Gestione sus recursos, pedidos y accesos desde la interfaz central de Cloud Temple.</div>
    </div>
  </a>
  <a href="storage/oss/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Almacenamiento Object S3</div>
      <div class="quickstart-desc">Configure su primer bucket compatible con S3 en pocos minutos.</div>
    </div>
  </a>
  <a href="iaas_vmware/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">Aprovisionar VMs</div>
      <div class="quickstart-desc">Cree sus primeras máquinas virtuales en la infraestructura IaaS de Cloud Temple.</div>
    </div>
  </a>
  <a href="llmaas/quickstart" class="quickstart-card">
    ...
    <div>
      <div class="quickstart-title">LLMaaS — IA Soberana</div>
      <div class="quickstart-desc">Acceda a los grandes modelos de lenguaje en un entorno SecNumCloud.</div>
    </div>
  </a>
</div>
...
<div class="popular-links-grid">
  <a class="popular-link" href="console/console_quickstart">
    <div class="popular-link-title">Quickstart de la Consola <span>→</span></div>
    <div class="popular-link-desc">Guía de inicio rápido para la Consola Cloud Temple</div>
  </a>
  <a class="popular-link" href="managed_kubernetes/quickstart">
    <div class="popular-link-title">Kubernetes Gestionado <span>→</span></div>
    <div class="popular-link-desc">Despliegue su primer clúster Kubernetes</div>
  </a>
  <a class="popular-link" href="llmaas/api">
    <div class="popular-link-title">Documentación API LLMaaS <span>→</span></div>
    <div class="popular-link-desc">Referencia completa de la API compatible con OpenAI</div>
  </a>
  <a class="popular-link" href="bastion/quickstart">
    <div class="popular-link-title">Bastion — Acceso seguro <span>→</span></div>
    <div class="popular-link-desc">Conexión SSH segura a sus recursos</div>
  </a>
  <a class="popular-link" href="iaas_vmware/concepts">
    <div class="popular-link-title">Arquitectura IaaS VMware <span>→</span></div>
    <div class="popular-link-desc">Comprender la infraestructura virtualizada de Cloud Temple</div>
  </a>
  <a class="popular-link" href="console/iam/iam">
    <div class="popular-link-title">IAM & Gestión de accesos <span>→</span></div>
    <div class="popular-link-desc">Identidades, roles y permisos en su tenant</div>
  </a>
</div>
