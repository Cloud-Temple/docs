...
### 11 de diciembre de 2025: Nuevas funcionalidades de Kubernetes administrado
...
- **Contratación (PR #191)**: Corrección y actualización del documento "Acuerdo de tratamiento de datos" (DPA).
