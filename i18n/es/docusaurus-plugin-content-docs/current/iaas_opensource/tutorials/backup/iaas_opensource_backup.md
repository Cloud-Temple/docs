...
Puede exportar una máquina virtual haciendo clic en el icono __'Exportar'__:
...
Diríjase a la página __'Máquinas Virtuales'__ en la sección __'OpenIaaS'__ del menú vertical situado en el lado izquierdo de la pantalla.

Seleccione una máquina virtual y luego el separador __'Políticas de copias de seguridad'__ de dicha máquina:
...
Diríjase a la página __'Máquinas Virtuales'__, seleccione una máquina virtual y luego la pestaña __'Políticas de copias de seguridad'__ de dicha máquina.

Elimine la política de copia de seguridad deseada y confirme la eliminación:

<img src={backupPolicyOpenIaas_003} />

__*Nota:*__ *¡Cuidado! __SecNumCloud exige que haya al menos una política de copia de seguridad asignada__ para cada máquina virtual.*

### ¿Cómo saber si una copia de seguridad se ha ejecutado correctamente?

Vaya a la página __'Informes'__ del menú __'Copia de seguridad'__ en el menú de navegación situado a la izquierda de su pantalla. Seleccione la política que desee y ábrala.

<img src={backupPolicyOpenIaas_004} />

Una vez seleccionada una política, tendrá acceso a las copias de seguridad ordenadas por __Fecha de inicio__.

<img src={backupPolicyOpenIaas_005} />

Dispondrá de los detalles completos de cada copia de seguridad a partir de la acción __Ver__.
