...
Para ver el conjunto de máquinas virtuales sin configuración de alta disponibilidad:
<img src={open_iaas_vm_ha_filter} />

Para ver el conjunto de máquinas virtuales que podrían impedir la activación de la alta disponibilidad en el pool:
