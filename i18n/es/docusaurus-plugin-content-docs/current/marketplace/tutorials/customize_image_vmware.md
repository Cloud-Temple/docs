...
Este tutorial explica cómo personalizar una imagen de máquina virtual (VMI) de VMware proporcionada por el Marketplace para crear sus propios modelos reutilizables.
...
Para desplegar desde la página **Máquinas Virtuelles** :

1. Haga clic en **"Crear una máquina virtual"**.
2. Seleccione **"Desplegar desde un modelo"**.
