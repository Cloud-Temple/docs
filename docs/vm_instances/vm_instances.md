...
<div class="card-grid">
  <div class="card">
    ...
    <a href="/docs/vm_instances/concepts" class="card-link">Explorer les concepts &rarr;</a>
  </div>
  <div class="card">
    <h3>Quickstart</h3>
    <p>Déployez votre première machine virtuelle en quelques minutes depuis la Marketplace Cloud Temple.</p>
    <a href="/docs/vm_instances/quickstart" class="card-link">Lancer le Quickstart &rarr;</a>
  </div>
</div>
