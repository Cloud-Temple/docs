...
Le service **VM Instances** de Cloud Temple est un produit de compute mutualisée qualifié **SecNumCloud**, permettant de déployer des machines virtuelles à la demande, sans gestion de l'infrastructure sous-jacente. Cette page présente les concepts fondamentaux du service.
