...
Seuls les **Opérateurs certifiés, Red Hat et MarketPlace** seront proposés dans les catalogue de l'**OperatorHub** sous réserve qu'ils soient **conformes aux exigences SecNumCloud** et qu'ils respectent les limitations de l'écosystème.
...
| Support des Opérateurs certifiés Red Hat | I | RA |
...
> * La gestion des **licences** et des **plans de supports spécifiques** sur des opérateurs **partenaires Red Hat** ne sont pas de la responsabilité de **Cloud Temple**. La gestion du support de ces opérateurs est déléguée défacto au partenaire fournissant le service.
>
---
...
L'assistance applicative concernant le développement, la configuration, la gestion et la maintenance des applications **n'est pas sous la responsabilité de Cloud Temple**. Le périmètre de responsabilité se concentre sur la gestion de l'infrastructure OpenShift et le déploiement des opérateurs.
Le **support des charges de travail** (applications déployées) et des pipelines CI/CD sont de la responsabilité du client ou de tout prestataire tiers désigné pour cette tâche.
