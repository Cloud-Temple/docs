...
1. [Conditions Générales de Vente et Utilisation (CGVU)](/docs/contractual/files/CT.AM.JUR.CGVU_Conditions%20Generales%20de%20Vente%20et%20d'Utilisation_v1.pdf)
2. [Convention de Service SecNumCloud](/docs/contractual/files/CT.AM.JUR.ANX%20-Annexe_Convention%20de%20Services_SNC_v2.pdf)
3. Convention spécifique particulière ¹
4. Plan d'Assurance Sécurité (PAS) ²
5. Conditions Particulières d'Utilisation (CPU)
6. [Data Protection Agreement](/docs/contractual/files/CT.AM.JANX%20-%20Annexe_DPA_v1.pdf)

:::info[Précisions contractuelles]
...
Retrouvez ici l'ensemble des documents contractuels Cloud Temple : conditions générales, accord de traitement des données (DPA), conventions de service SecNumCloud et accords de niveau de service.
