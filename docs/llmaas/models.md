...
Cloud Temple LLMaaS propose **46 modèles de langage large** soigneusement sélectionnés et optimisés pour répondre aux exigences **SecNumCloud** les plus strictes. Notre catalogue couvre l'ensemble du spectre, des micro-modèles ultra-efficaces aux modèles extrêmement volumineux.

### Statistiques Globales

| Métrique | Valeur |
|----------|--------|
| **Nombre total de modèles** | 46 modèles |
...
**Spécifications techniques:**
- **Vitesse** : 103 tokens/seconde
- **Consommation** : 1.41 kWh/million tokens
...
- Analyse de documents longs (200k)
- Tâches de raisonnement avec faible latence

---

### glm-4.7:358b
> ⚠️ **ATTENTION : Ce modèle est déprécié.** Modèle supprimé du catalogue le 30/03/2026.
...
**Spécifications techniques:**
- **Vitesse** : 98 tokens/seconde
- **Consommation** : 1.47 kWh/million tokens
- **Licence** : [Apache 2.0](./licences/apache_2.0.licence.md)
- **Localisation** : FR 🇫🇷
...
**Tags :** `Agent` `Programmation` `MoE` `Grand Contexte` `AWQ`

**Cas d'usage :**
- Assistant de programmation avancé (Repo-scale)
...
### qwen3-coder:30b
> ⚠️ **ATTENTION : Ce modèle est déprécié.** Préconisation de migration vers qwen-coder-next:80b.
...
Seconde itération de Devstral (Small 2), modèle agentique de pointe pour l'ingénierie logicielle, déployé sur serveur GPU haute performance.

**Spécifications techniques:**
- **Vitesse** : 38 tokens/seconde
- **Consommation** : 3.80 kWh/million tokens
- **Licence** : [Apache 2.0](./licences/apache_2.0.licence.md)
- **Localisation** : FR 🇫🇷
...
**Tags :** `Agent` `Programmation` `Vision` `Open-Source` `Grand Contexte` `FP8` `Rapide`

**Cas d'usage :**
- Agents de codage autonomes nécessitant une faible latence
...
### devstral:24b
> ⚠️ **ATTENTION : Ce modèle est déprécié.** Préconisation de migration vers devstral-small-2:24b.
...
**Spécifications techniques:**
- **Vitesse** : 58 tokens/seconde
- **Consommation** : 2.30 kWh/million tokens
- **Licence** : [Apache 2.0](./licences/apache_2.0.licence.md)
- **Localisation** : FR 🇫🇷
...
### qwen3-2507:4b
> ⚠️ **ATTENTION : Ce modèle est déprécié.** Déprécié.
...
- Traduction sur appareils à ressources limitées
