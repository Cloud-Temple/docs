...
Cloud Temple LLMaaS propose **44 modèles de langage large** soigneusement sélectionnés et optimisés pour répondre aux exigences **SecNumCloud** les plus strictes. Notre catalogue couvre l'ensemble du spectre, des micro-modèles ultra-efficaces aux modèles extrêmement volumineux.

### Statistiques Globales

| Métrique | Valeur |
|----------|--------|
| **Nombre total de modèles** | 44 modèles |
...
- **Consommation** : 4.40 kWh/million tokens
...
- **Licence** : [LLAMA 3.1 Community Licence](./licences/llama_3.1_community_licence.licence.md)
- **Localisation** : FR 🇫🇷
...
**Spécifications techniques:**
- **Vitesse** : 48 tokens/seconde
- **Consommation** : 5.50 kWh/million tokens
- **Licence** : [Apache 2.0](./licences/apache_2.0.licence.md)
- **Localisation** : FR 🇫🇷
...
**Spécifications techniques:**
- **Vitesse** : 162 tokens/seconde
- **Consommation** : 0.10 kWh/million tokens
- **Licence** : [MIT licence](./licences/mit_licence.licence.md)
- **Localisation** : FR 🇫🇷
